...
const Contact = ({id}) => {
  return (
    <section id={id} className="bg-gradient-to-b from-blue-200 to-purple-200 py-12  ">
      <div className="container mx-auto px-4 md:px-8 max-w-[1170px] text-[#081356]">
        {/* Title */}
        <h2 className="text-[35px] lg:text-[60px] font-semi-bold leading-[55px] lg:leading-[80.49px]  text-center mb-10">Contact</h2>

        {/* Address and Hours */}
        <div className="text-[15px] leading-[20px]  lg:text-lg lg:leading-relaxed ">
          ...
          <div className="grid lg:grid-cols-2 gap-x-4 gap-y-2 mb-8">
            <p>Lundi:</p>
